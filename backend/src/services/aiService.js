...
Студент допустил ошибки / пропустил следующие вопросы:
...
- Дай совет как запомнить этот материал (мнемоника, ассоциации)
- Укажи какую тему нужно повторить
[/WEAK_TOPICS]
[RECOMMENDATIONS]
Составь краткий план обучения:
- Какие темы повторить в первую очередь
- Конкретные шаги для улучшения
- Рекомендуемые источники или методы запоминания
[/RECOMMENDATIONS]`;
}
